      ...
      <div className="nosotros-container pro">
        ...
        <div className="nosotros-content">
          ...
          <div className="nosotros-cta">
            <button onClick={() => setShowContactPopup(true)} className="cta-btn">Contactar con AgroUY</button>
          </div>
        </div>
      </div>
        ...
        <div className="modal-backdrop" onClick={() => setShowContactPopup(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="contact-info">
              ...
              <p><strong>Dirección:</strong> Av. del Libertador 1234, Montevideo, Uruguay</p>
            </div>
